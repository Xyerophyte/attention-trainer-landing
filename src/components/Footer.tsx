...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    community: [
      { name: 'GitHub', href: 'https://github.com/Xyerophyte/attention-trainer-extension', external: true },
      { name: 'Discussions', href: 'https://github.com/Xyerophyte/attention-trainer-extension/discussions', external: true },
      { name: 'Bug Reports', href: 'https://github.com/Xyerophyte/attention-trainer-extension/issues', external: true },
      { name: 'Feature Requests', href: 'https://github.com/Xyerophyte/attention-trainer-extension/issues/new?template=feature_request.md', external: true }
    ]
  }
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <motion.a
                href="https://github.com/Xyerophyte/attention-trainer-extension"
                target="_blank"
